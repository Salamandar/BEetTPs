...
Les résultats expérimentaux sont assez proches de la théorie, à un décalage près en $\theta$ (1,5\textdegree) : le repérage de l'axe optique principal Z aurait pu être plus précis.
