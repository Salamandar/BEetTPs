...
\begin{figure}[H]
\includegraphics[width=150pt]{../15Decembre/pmosIDs_Vg.png}
\includegraphics[width=150pt]{../15Decembre/Ids_Vg.png}
\caption{Comparaison des caractéristiques de PMOS et NMOS}
\end{figure}

La caractéristique pour PMOS est le symétrique de celle du NMOS, les valeurs de $V_t$ sont similaires et négatives. 
