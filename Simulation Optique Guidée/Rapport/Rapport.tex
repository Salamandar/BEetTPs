...
Nous avons étudié la théorie dans la partie précédente, il faut maintenant la mettre en application afin de déterminer des paramètres de fonctionnement optimaux. Ainsi, dans toute la suite, nous utiliserons des longueurs d'onde de foncionnement $\lambda_1=1.55\mu m$ et $\lambda_2=1.31\mu m$
